...
chart1_panel <- tabPanel(
  ...
  p("In chart 1, the amount of passengers is mapped out to show the changes 
  throughout the year. 
    This line graph contains 3 separate lines that correlate to the first 3 
    months of the year. 
    By being able to visualize the data by month, the changes in passenger 
    density because there are holidays and events within certain months. 
    This separation also allows for the visualized graph to have clearer 
    relationships, outlining the sharp decline in passengers at March of 2020 
    as calculated from the second function. 
    Besides the decrease that occurred in March, the data prior had a general 
    positive trend, 
    the increase and decrease of passenger density of each month is generally 
...
chart2_panel <- tabPanel(
  ...
  p("Chart 2 shows the changes in the total passengers by each carrier, each of 
  the totals were calculated based on the year. 
